...
def bent_over_barbell_row(video_path):
    ...
    while True:
        ...
        if len(lmList) != 0:
            ...
            angle_left_side_shoulder = detector.findAngle(img, 23, 11, 13)
            angle_left_side_back = detector.findAngle(img, 11, 23, 25)
            per_left_elbow = np.interp(angle_left_side_elbow, (190, 265), (0, 100))
            per_left_shoulder = np.interp(angle_left_side_shoulder, (55, 335), (0, 100))
            ...
            if per_left_elbow == 100 and per_left_shoulder == 0:
                if dir == 0:
                    count += 0.5
                    dir = 1
            ...
            if per_left_elbow == 0 and per_left_shoulder == 100:
                if dir == 1:
                    count += 0.5
                    dir = 0
